...
v21_SAC_step_reward_plot = np.load(os.path.join(file_path, "array/v21_SAC_step_reward_plot.npy"))
v21_A2C_step_reward_plot = np.load(os.path.join(file_path, "array/v21_A2C_step_reward_plot.npy"))
v21_PPO_step_reward_plot = np.load(os.path.join(file_path, "array/v21_PPO_step_reward_plot.npy"))
v21_TD3_step_reward_plot = np.load(os.path.join(file_path, "array/v21_TD3_step_reward_plot.npy"))
smoothed_v21_SAC_step_reward_plot = gaussian_filter1d(v21_SAC_step_reward_plot, sigma=40.0)
...
plt.plot(v21_TD3_epoch_plot, v21_SAC_step_reward_plot[:length], color='red', alpha=0.1)
