...
step_reward_plot_8 = np.load(os.path.join(file_path, "array/step_reward_plot_8.npy"))
step_reward_plot_9 = np.load(os.path.join(file_path, "array/step_reward_plot_9.npy"))
