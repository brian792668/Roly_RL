...
if __name__ == '__main__':
    ...
    np.save(os.path.join('Roly/Inverse_kinematics/label200point.npy'), label200point_np)
    np.save(os.path.join('Roly/Inverse_kinematics/joint200point.npy'), joint200point_np)
    print("Done labeling\n")
