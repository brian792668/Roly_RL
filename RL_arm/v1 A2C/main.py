...
def train(model, env, current_model_path, best_model_path, best_step_model_path):
    ...
    if os.path.exists("RL/RL_arm/v1 A2C/model/model_1/array/epoch_plot.npy"):
        epoch_plot = np.load("RL/RL_arm/v1 A2C/model/model_1/array/epoch_plot.npy")
        step_reward_plot = np.load("RL/RL_arm/v1 A2C/model/model_1/array/step_reward_plot.npy")
        total_reward_plot = np.load("RL/RL_arm/v1 A2C/model/model_1/array/total_reward_plot.npy")
        best_avg_total_reward = np.load("RL/RL_arm/v1 A2C/model/model_1/array/best_avg_total_reward.npy")
        best_avg_step_reward = np.load("RL/RL_arm/v1 A2C/model/model_1/array/best_avg_step_reward.npy")

    else:
        np.save("RL/RL_arm/v1 A2C/model/model_1/array/epoch_plot.npy", epoch_plot)
        np.save("RL/RL_arm/v1 A2C/model/model_1/array/step_reward_plot.npy", step_reward_plot)
        np.save("RL/RL_arm/v1 A2C/model/model_1/array/total_reward_plot.npy", total_reward_plot)
        np.save("RL/RL_arm/v1 A2C/model/model_1/array/best_avg_total_reward.npy", best_avg_total_reward)
        np.save("RL/RL_arm/v1 A2C/model/model_1/array/best_avg_step_reward.npy", best_avg_step_reward)
    ...
    while True:
        ...
        plt.savefig("RL/RL_arm/v1 A2C/model/model_1/epoch_vs_reward.png")
        plt.close()
...
if __name__ == '__main__':
    my_env = RL_arm()
    best_model_path = "RL/RL_arm/v1 A2C/model/model_1/best_model.zip"
    best_step_model_path = "RL/RL_arm/v1 A2C/model/model_1/best_step_model.zip"
    current_model_path = "RL/RL_arm/v1 A2C/model/model_1/current_model.zip"
