...
def train(model, env, current_model_path):
    ...
    if os.path.exists("RL/RL_arm/v11_A2C/model/array/epoch_plot.npy"):
        epoch_plot = np.load("RL/RL_arm/v11_A2C/model/array/epoch_plot.npy")
        step_reward_plot = np.load("RL/RL_arm/v11_A2C/model/array/step_reward_plot.npy")
        total_reward_plot = np.load("RL/RL_arm/v11_A2C/model/array/total_reward_plot.npy")
        best_avg_total_reward = np.load("RL/RL_arm/v11_A2C/model/array/best_avg_total_reward.npy")
        best_avg_step_reward = np.load("RL/RL_arm/v11_A2C/model/array/best_avg_step_reward.npy")

    else:
        np.save("RL/RL_arm/v11_A2C/model/array/epoch_plot.npy", epoch_plot)
        np.save("RL/RL_arm/v11_A2C/model/array/step_reward_plot.npy", step_reward_plot)
        np.save("RL/RL_arm/v11_A2C/model/array/total_reward_plot.npy", total_reward_plot)
        np.save("RL/RL_arm/v11_A2C/model/array/best_avg_total_reward.npy", best_avg_total_reward)
        np.save("RL/RL_arm/v11_A2C/model/array/best_avg_step_reward.npy", best_avg_step_reward)
    ...
    while True:
        ...
        if avg_step_reward >= best_avg_step_reward[0]:
            ...
            model.save(f"RL/RL_arm/v11_A2C/model/best_step/best_step_model_epoch{epoch}.zip")
        ...
        if avg_total_reward >= best_avg_total_reward[0]:
            ...
            model.save(f"RL/RL_arm/v11_A2C/model/best_total/best_total_model_epoch{epoch}.zip")
        ...
        plt.savefig("RL/RL_arm/v11_A2C/model/epoch_vs_reward.png")
        plt.close()
       
def test(model, env, model_path):
    model = stable_baselines3.A2C.load(model_path, env)
...
if __name__ == '__main__':
    my_env = RL_arm()
    best_model_path = "RL/RL_arm/v11_A2C/model/best_model.zip"
    current_model_path = "RL/RL_arm/v11_A2C/model/current_model.zip"
    if os.path.exists(current_model_path):
        print(f"model file: {current_model_path}")
        my_model = stable_baselines3.A2C.load(current_model_path, my_env)
    else:
        my_model = stable_baselines3.A2C('MlpPolicy', my_env, verbose=0)
