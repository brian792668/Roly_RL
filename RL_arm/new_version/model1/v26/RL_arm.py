...
class RL_arm(gym.Env):
    ...
    def get_state(self):
        ...
        # vectors
        self.obs.obj_to_neck_xyz = [self.data.qpos[15]-shoulder_xyz[0],      self.data.qpos[16]-shoulder_xyz[1],      self.data.qpos[17]-shoulder_xyz[2]]
    ...
    def spawn_new_point(self):
        ...
        if self.inf.timestep == 0 or self.sys.hand2target <= 0.05 or hand_camera_center <= 5:
            ...
            while reachable == False:
                ...
                self.sys.pos_target0[1] = random.uniform(-0.75, 0.25)
