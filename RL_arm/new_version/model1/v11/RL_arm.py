    ...
    def step(self, action): 
        ...
        #     return self.observation_space, self.inf.reward, self.inf.done, self.inf.truncated, self.inf.info
            ...
            for i in range(int(1/self.sys.Hz/0.001)):
                self.sys.ctrlpos[3] = self.sys.pos[3] + np.tanh(0.2*(self.sys.arm_target_pos[0] - self.sys.pos[3]))*0.01*alpha
                self.sys.ctrlpos[4] = self.sys.pos[4] + np.tanh(0.2*(self.sys.arm_target_pos[1] - self.sys.pos[4]))*0.01*alpha
                self.sys.ctrlpos[5] = self.sys.pos[5] + np.tanh(0.2*(self.sys.arm_target_pos[2] - self.sys.pos[5]))*0.01*alpha
                self.sys.ctrlpos[6] = self.sys.pos[6] + np.tanh(0.2*(self.sys.arm_target_pos[3] - self.sys.pos[6]))*0.01*alpha
                self.sys.ctrlpos[7] = self.sys.pos[7] + np.tanh(0.2*(self.sys.arm_target_pos[4] - self.sys.pos[7]))*0.01*alpha
