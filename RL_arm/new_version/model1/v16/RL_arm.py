    ...
    def step(self, action): 
        ...
        if self.viewer.is_running() == False:
            ...
            for i in range(int(1/self.sys.Hz/0.001)):
                ...
                self.sys.ctrlpos[4] = self.sys.ctrlpos[4] + self.inf.action[1]*0.002
                self.sys.ctrlpos[5] = 0
                self.sys.ctrlpos[6] = self.sys.ctrlpos[6] + np.tanh(self.sys.arm_target_pos[3] - self.sys.pos[4])*0.002
