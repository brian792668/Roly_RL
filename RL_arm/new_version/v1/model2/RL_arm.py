...
class RL_arm(gym.Env):
    def __init__(self):
        ...
        self.model1 = SAC.load(os.path.join(os.path.dirname(os.path.abspath(__file__)), "../../../old_version/v15/model/SAC/best_total/best_total_model_epoch1112.zip"))
    ...
    def step(self, action): 
        ...
        if self.viewer.is_running() == False:
            ...
            self.inf.action[0] = self.inf.action[0]*0.5 + action_from_model1[0]*0.5
            self.inf.action[1] = self.inf.action[1]*0.5 + action[0]*0.5
            self.inf.action[2] = self.inf.action[2]*0.5 + action_from_model1[2]*0.5
            self.inf.action[3] = self.inf.action[3]*0.5 + action_from_model1[3]*0.5
