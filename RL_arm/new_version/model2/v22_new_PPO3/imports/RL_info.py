...
class RL_sys():
    def __init__(self, Hz = 50):
        ...
        self.limit_high = [ 1.57, 1.57, 1.57, 1.95, 3.14]
        self.limit_low  = [-3.10,-1.57,-1.57, 0.00, 0.00]
        ...
        self.grasping_dis = 0.10

        self.vec_temp_to_neck = [0.0, 0.0, 0.0]
        self.pos_temp_target  = [0.0, 0.0, 0.0]
        self.pos_grasp_point  = [0.0, 0.0, 0.0]
