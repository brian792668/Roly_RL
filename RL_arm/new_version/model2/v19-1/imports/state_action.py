...
obs_high = np.concatenate([[0.50,  0.00,  0.00], [ 1.57,  1.05,  1.57,  2.10], [1.00]*100]).astype(np.float32)
obs_low  = np.concatenate([[0.00, -0.75, -0.60], [-1.05, -1.57, -1.57,  0.00], [0.15]*100]).astype(np.float32)