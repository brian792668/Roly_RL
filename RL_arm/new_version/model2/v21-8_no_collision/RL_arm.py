...
class RL_arm(gym.Env):
    ...
    def get_reward(self):
        ...
        # 獎勵對應部分的比例長度
        r1r2_length = int((0.3*r2*r1) * 40)  # r1 部分長度
        r3_length = int((0.7*r3) * 40)  # r3 部分長度
        r1r2_bar = "." * r1r2_length + " " * int(0.3*40 - r1r2_length)
        r3_bar = "." * r3_length + " " * int(0.7*40 - r3_length)

        status_bar = f"| {r1r2_bar}{r3_bar}|"
