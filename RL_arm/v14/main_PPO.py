...
def train(model, env, current_model_path):
    ...
    if os.path.exists("Roly/RL_arm/v14/model/PPO/array/epoch_plot.npy"):
        epoch_plot = np.load("Roly/RL_arm/v14/model/PPO/array/epoch_plot.npy")
        step_reward_plot = np.load("Roly/RL_arm/v14/model/PPO/array/step_reward_plot.npy")
        total_reward_plot = np.load("Roly/RL_arm/v14/model/PPO/array/total_reward_plot.npy")
        best_avg_total_reward = np.load("Roly/RL_arm/v14/model/PPO/array/best_avg_total_reward.npy")
        best_avg_step_reward = np.load("Roly/RL_arm/v14/model/PPO/array/best_avg_step_reward.npy")

    else:
        np.save("Roly/RL_arm/v14/model/PPO/array/epoch_plot.npy", epoch_plot)
        np.save("Roly/RL_arm/v14/model/PPO/array/step_reward_plot.npy", step_reward_plot)
        np.save("Roly/RL_arm/v14/model/PPO/array/total_reward_plot.npy", total_reward_plot)
        np.save("Roly/RL_arm/v14/model/PPO/array/best_avg_total_reward.npy", best_avg_total_reward)
        np.save("Roly/RL_arm/v14/model/PPO/array/best_avg_step_reward.npy", best_avg_step_reward)
    ...
    while True:
        ...
        if avg_step_reward >= best_avg_step_reward[0]:
            ...
            model.save(f"Roly/RL_arm/v14/model/PPO/best_step/best_step_model_epoch{epoch}.zip")
        ...
        if avg_total_reward >= best_avg_total_reward[0]:
            ...
            model.save(f"Roly/RL_arm/v14/model/PPO/best_total/best_total_model_epoch{epoch}.zip")
        ...
        plt.savefig("Roly/RL_arm/v14/model/PPO/epoch_vs_reward.png")
        plt.close()
...
if __name__ == '__main__':
    my_env = RL_arm()
    best_model_path = "Roly/RL_arm/v14/model/PPO/best_model.zip"
    current_model_path = "Roly/RL_arm/v14/model/PPO/current_model.zip"
