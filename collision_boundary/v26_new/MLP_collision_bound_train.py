...
def train(numberofpoints, version):
    ...
    for epoch in range(epochs):
        ...
        if epoch_loss < min_train_loss:
            ...
            torch.save(model.state_dict(), os.path.join(file_path, f'MLP_collision_bound.pth'))
        ...
        plt.legend()
        plt.grid(True)
        plt.savefig(os.path.join(file_path, f"MLP_collision_bound_{version}.png"))
        plt.close()
...
if __name__ == '__main__':
    train(numberofpoints=2048000, version="v2")
